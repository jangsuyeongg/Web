...
<hr/>
<h1>배열 데이터를 반복시키기</h1>
<c:set var="arr" value="<%=new int[]{56,47,5,68,47,56,65} %>"/>
<ol>
...
<%
	...
	map.put("박보검","서울시 마포구");
	map.put("박서준","서울시 서대문구");
	map.put("송중기","서울시 영등포구");
%>
